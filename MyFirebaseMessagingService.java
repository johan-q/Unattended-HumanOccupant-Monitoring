package com.qppd.carmonitoring;//package com.qppd.eggincubator;
//
...
//
//public class com.qppd.carmonitoring.MyFirebaseMessagingService extends FirebaseMessagingService {
//    @Override
//    public void onNewToken(String token) {
//
//        // Log or save the token as needed
//        Log.d("FIREBASE TOKEN", token);
//        //Toast.makeText(com.qppd.carmonitoring.MyFirebaseMessagingService.this, tokesn, Toast.LENGTH_LONG).show();
//
...
import com.google.firebase.messaging.FirebaseMessagingService;
import com.google.firebase.messaging.RemoteMessage;
import com.qppd.carmonitoring.Classes.Token;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onNewToken(String token) {
        ...
        Token token1 = new Token(token);
        FirebaseDatabase.getInstance().getReference().child("carmonitoring/tokens").push().setValue(token1, (error, ref) -> {
            if (error != null) {
                Log.d("Resetting Incubator failed", error.getMessage(), null);
            }
        });
